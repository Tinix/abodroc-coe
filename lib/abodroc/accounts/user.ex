defmodule Abodroc.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Abodroc.Repo)
  ...
  """
  def valid_password?(%Abodroc.Accounts.User{hashed_password: hashed_password}, password)
