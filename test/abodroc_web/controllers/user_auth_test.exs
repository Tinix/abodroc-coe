defmodule AbodrocWeb.UserAuthTest do
  use AbodrocWeb.ConnCase, async: true

  alias Abodroc.Accounts
  alias AbodrocWeb.UserAuth
  import Abodroc.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AbodrocWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      AbodrocWeb.Endpoint.subscribe(live_socket_id)
